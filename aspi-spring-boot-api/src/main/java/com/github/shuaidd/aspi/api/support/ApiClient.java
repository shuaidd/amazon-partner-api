...
import com.github.shuaidd.aspi.api.auth.ApiKeyAuth;
import com.github.shuaidd.aspi.api.auth.Authentication;
import com.github.shuaidd.aspi.api.auth.HttpBasicAuth;
import com.github.shuaidd.aspi.api.auth.OAuth;
    ...
    */
    ...
    public <T> T handleResponse(Response response, Type returnType) throws ApiException {
        if (response.isSuccessful()) {
            ...
            logger.error("执行请求出错-{}--{}",respBody,response.headers().toMultimap());
