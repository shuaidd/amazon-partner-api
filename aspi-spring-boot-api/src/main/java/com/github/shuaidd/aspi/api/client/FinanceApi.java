...
import com.github.shuaidd.aspi.model.finance.ListFinancialEventGroupsResponse;
import com.github.shuaidd.aspi.model.finance.ListFinancialEventsResponse;
...
public class FinanceApi extends AbstractAmazonApi<FinanceApi> {
    ...
    private com.squareup.okhttp.Call listFinancialEventGroupsValidateBeforeCall(Integer maxResultsPerPage, OffsetDateTime financialEventGroupStartedBefore, OffsetDateTime financialEventGroupStartedAfter, String nextToken, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        return listFinancialEventGroupsCall(maxResultsPerPage, financialEventGroupStartedBefore, financialEventGroupStartedAfter, nextToken, progressListener, progressRequestListener);
    }
